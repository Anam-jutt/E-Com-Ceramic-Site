    ...
    <div>
      ...
      <div className="siteTColor xl:flex gap-3 lg:flex md:flex mt-20 px-6 sm:px-12 md:px-20 pb-10">
        ...
        <form
          ...
          className="xl:w-1/2 lg:w-1/2 md:w-1/2 sm:w-full w-full bg-gray-100 pt-10 px-8 pb-10"
        >
          <p>Name *</p>
          <div className="flex mt-2 flex-wrap gap-4">
            <input
              ...
              className="xl:w-[48%] lg:w-[48%] w-full p-2 bg-white rounded-lg"
              ...
              {({ open }) => (
                <div>
                  ...
                  <Disclosure.Panel className="px-4 pt-2 pb-4 text-gray-600 bg-white rounded-b-lg">
                    ...
                    shipping options, delivery times, and tracking your ceramic
                    product shipments.
                  </Disclosure.Panel>
                </div>
              )}
              ...
              {({ open }) => (
                <div>
                  ...
                  <Disclosure.Panel className="px-4 pt-2 pb-4 text-gray-600 bg-white rounded-b-lg">
                    ...
                    explains how to initiate a return, the eligibility criteria,
                    and the refund process for your ceramic purchases.
                  </Disclosure.Panel>
                </div>
              )}
            </Disclosure>
